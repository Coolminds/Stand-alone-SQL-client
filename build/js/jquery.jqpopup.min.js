/* jQpopup - jQuery Popup Box v0.2.3
...
},open:function(button_id,object_id,modal){if($("#"+object_id).html()!=""){var content=$.jQpopup.box(object_id);
$("body").append(content);
$("#"+object_id+"_p").bgiframe();
$("#"+object_id+"_p").jqDrag(".jqpopup_header").jqResize(".jqpopup_resize");
if(modal){$("body").append(overlay=$('<div id="jqpopup_overlay"></div>'));
$("#jqpopup_overlay").show()
...
$("#"+object_id).empty();
if($("#"+object_id+"_p").height()<$.jQpopup.minHeight){$("#"+object_id+"_p").css("height",$.jQpopup.minHeight)
}else{$("#"+object_id+"_p").css("height",$("#"+object_id+"_p").height())
...
},jqpopup_open:function(button_id,modal){return this.each(function(){$.jQpopup.open(button_id,this.id,modal)
})
